	...
	//┘
		...
		/*
			...
			// ▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔
				...
				let a = done => setTimeout(() => { console.log('a'), done() }, 2400);
				let b = done => setTimeout(() => { console.log('b'), done() }, 1200);
				let c = done => ( console.log('c'), done() );
				let d = done => setTimeout(() => { console.log('d'), done() }, 2000);
				let e = done => ( console.log('e'), done() );
				let f = done => ( console.log('f'), done() );
...
//┘
	...
	module.exports = { create: __create, series: __series, parallel: __parallel };
