...
//┘
	...
	function CombaList (options)
	{
		...
		// ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
			...
			ctx.tasks = (options.list.length) ? make.values(options.list) : options.list;
			...
			Object.defineProperties(instance,
			{
				...
				// ─────────────────────────────────────────────────
					...
					prepend:
					{
						...
						{
							if (values.length) {
								tasks.unshift(...make.values(values));
							}
