...
//┘
	...
	//┘
		...
		const __defaultCombaOptions = getobj();

		__defaultCombaOptions.parallel = false;
		__defaultCombaOptions.limit = 0;
		__defaultCombaOptions.delay = 0;
		__defaultCombaOptions.interval = 0;
		__defaultCombaOptions.list = [];
...
//┘
	...
	{
		options = Object.assign({}, __defaultCombaOptions, options || {});
		...
		ctx.tasks = __prepareTasks(options.list);
...
//┘
	...
	const __create = (options) => new Comba(options);
