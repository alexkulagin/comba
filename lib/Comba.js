	...
	//┘
		...
		/*
			...
			// ▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔
				...
				series(a, b).append(c, d).prepend(e, f).run() // e › f › a › b › c › d
...
//┘
	...
	function Comba (options, ...values)
	{
		...
		ctx.tasks = __prepareValues(values);
		ctx.instance = this;
...
//┘
	...
	function __prepareValues (values)
	{
		if (!values.length) {
			return values;
		}
	...
	//┘
		...
		function __parseValue (value, tasks = [])
		{
			if (isFunction(value)) {
				tasks.push(value);
			}
